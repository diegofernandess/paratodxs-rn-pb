...
Embora possam haver argumentos na linguagem natural contendo sentenças interrogativas ou imperativas, neste livro esses argumentos serão considerados como sendo reformuláveis em argumentos contendo somente sentenças que podem ser verdadeiras ou falsas, isto é, sentenças declarativas. 
A motivação (que não é amplamente aceita) é que sempre que um argumento contém uma sentença não declarativa, como uma pergunta retórica, esta pode ser transformada em uma sentença declarativa preservando o significado que é pertinente para o argumento em questão.
