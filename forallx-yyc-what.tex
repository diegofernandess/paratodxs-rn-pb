...
\end{earg}
são argumentos válidos. Mas enquanto a validade do primeiro depende do conteúdo (ou seja, o significado de ``oftalmologista'' e ``oculista''), a validade do segundo não depende disso.
...
Esta situação não é conceitualmente concebível: ela é descartada pelos significados de ``oftalmologista'' e ``oculista''.
