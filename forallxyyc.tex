%\triangleright\bullet\leftthreetimes
...
\begin{textblock*}{0in}(0in,0in)
  ...
  \begin{minipage}[b][\stockheight][s]{.9\stockwidth}
    \begin{raggedleft}
      ...
      \color{lyallpink}
      \textbf{ParaTod}%
	    \fontsize{80pt}{0pt}\selectfont\rmfamily\textit{\textbf{x}\/}\textbf{s}
      ...
      \textit{Adaptado, re-remixado, re-revisado e ampliado  pelo}\\
      \textbf{GEL - Grupo de Estudos em Lógica da UFRN}\\
      \textit{Atualmente em processo de} re-re-$\overset{n}{\ldots}$\textit{-mixagem pela}\\
      \textbf{UFPB}\\
      \vspace{1cm}
