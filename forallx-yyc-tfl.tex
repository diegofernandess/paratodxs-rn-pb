...
\practiceproblems
\solutions
\problempart Usando o esquema a seguir, simbolize cada uma das 6 sentenças abaixo na LVF.\label{pr.monkeysuits}
	\begin{ekey}
...
\problempart Usando o esquema a seguir, simbolize cada uma das 12 sentenças abaixo na LVF.
\begin{ekey}
...
\problempart Usando o esquema a seguir, simbolize cada uma das 12 sentenças abaixo na LVF.\label{pr.avacareer}
	\begin{ekey}
...
\problempart
Usando o esquema a seguir, simbolize cada uma das 9 sentenças abaixo na LVF.
...
\problempart
\label{pr.spies}
Proponha um esquema de simbolização e utilize-o para simbolizar  cada uma das 6 sentenças abaixo na LVF.
\begin{earg}
...
\solutions
\problempart Proponha um esquema de simbolização e utilize-o para simbolizar  cada uma das 5 sentenças abaixo na LVF.
\begin{earg}
...
\problempart
Para cada um dos 3 argumentos abaixo, identifique sua conclusão e suas premissas, proponha um esquema de simbolização e use-o para simbolizar todas as sentenças do argumento na LVF.
\begin{earg}
...
\problempart
Para cada um dos três argumentos abaixo, identifique sua conclusão e suas premissas, proponha um esquema de simbolização e utilize-o para simbolizar o  argumento da melhor maneira possível na LVF.
