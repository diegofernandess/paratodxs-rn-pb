...
Um quantificador deve ser seguido sempre por uma \define{variavel}.
...
\end{quote}
Assumindo a chave de simbolização do argumento anterior, podemos adicionar um predicado (faça `$\atom{J}{x}$' significar `$x$ é uma tenista') e um nome (seja `$c$' o nome de Carol na LPO).
